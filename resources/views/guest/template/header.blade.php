<head>
    ...
    <!-- icofont CSS -->
    <link rel="stylesheet" href="{{asset('guest/css/icofont.css')}}">
    <!-- Slicknav -->
    <link rel="stylesheet" href="{{asset('guest/css/slicknav.min.css')}}">
    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" href="{{asset('guest/css/owl-carousel.css')}}">
    <!-- Datepicker CSS -->
    <link rel="stylesheet" href="{{asset('guest/css/datepicker.css')}}">
    <!-- Animate CSS -->
