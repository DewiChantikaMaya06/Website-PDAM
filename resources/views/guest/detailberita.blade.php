                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                <!-- News Head -->
                                <div class="news-head">
                                    <img src="{{asset('guest/img/blog1.jpg')}}" alt="#">
                                </div>
                                <!-- News Title -->
                                ...
                                <div class="meta">
                                    <div class="meta-left">
                                        <span class="author"><a href="#"><img src="{{asset('guest/img/author1.jpg')}}" alt="#">Naimur Rahman</a></span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="single-image">
                                                    <img src="{{asset('guest/img/blog2.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="single-image">
                                                    <img src="{{asset('guest/img/blog3.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
